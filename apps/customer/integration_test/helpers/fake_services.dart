...
class FakeAuthService implements IAuthService {
  ...
  Future<void> verifyPhoneNumber({
    ...
    onCodeSent('fake-verification-id', null);
  }
  ...
  Future<void> updateDocuments({
    ...
    for (final docId in documentIds) {
      await updateDocument(
          collection: collection, documentId: docId, data: data);
    }
  }
...
class FakeStorageService implements IStorageService {
  ...
  Future<CloudinaryUploadResult> uploadFile({
    ...
    return const CloudinaryUploadResult(
      secureUrl: 'https://fake.cloudinary.com/uploaded',
  ...
  @override
  String getThumbnailUrl(String publicId, {int size = 100}) => publicId;

  @override
  String getMediumUrl(String publicId, {int size = 400}) => publicId;
}
...
class FakeCacheService implements ICacheService {
  ...
  bool containsKey(String box, String key) {
    return _store[box]?.containsKey(key) ?? false;
  }
}

class FakeLocalNotificationService implements ILocalNotificationService {
  @override
  ...
  @override
  Stream<int> get onNotificationTap => const Stream.empty();

  @override
  Stream<String?> get onNotificationPayloadTap => const Stream.empty();
