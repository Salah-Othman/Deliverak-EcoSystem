...
class CategoryModelFixture {
  CategoryModelFixture._();

  static CategoryModel create({
    String categoryId = 'cat-1',
    String name = 'Burgers',
    String image = 'https://example.com/cat.jpg',
    DeliveryType type = DeliveryType.food,
    int sortOrder = 0,
  }) {
